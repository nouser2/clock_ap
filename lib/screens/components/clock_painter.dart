...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Minute Calculation
    double minX =
        centerX + size.width * 0.33 * cos((dateTime.minute * 6) * pi / 180);
    double minY =
        centerY + size.width * 0.33 * sin((dateTime.minute * 6) * pi / 180);
...
// center Dots
    ...
    canvas.drawCircle(
        center, 17, Paint()..color = Theme.of(context).colorScheme.background);
    canvas.drawCircle(center, 7, dotPainter);
  }
